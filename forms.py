...
from wtforms import StringField, SubmitField, PasswordField, TextAreaField, BooleanField, SearchField
...
class LoginForm(FlaskForm):
    email = StringField('Email: ', validators=[Email(message='Not a valid email address')], render_kw={"placeholder": "Please enter your e-mail"})
